# 0047: A rule that can be executed is not left in prose
...
The same block carries a second one, acquired the same way. Its last line reads
`bun run changelog 0.8.0`, and 0.9.0 shipped on 2026-08-05. The version is an
illustration rather than a claim, which is exactly why nobody updates it and why
it is worth naming: a copy goes stale in the places nobody is reading, and those
are the places a reader who does not already know the answer will look.
