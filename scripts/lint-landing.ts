 ...
 * (decisions 0033 §1, 0044 §1, 0045 §5).
 *
...
/** Everything 0033 §1 and 0045 §5 send through a pull request. */
 ...
 * 0045 §5 lands it through review with the code it describes. Read without this
 ...
 * an opinion about it, because 0045 §5 does not name it.
 */
